...
def upgrade() -> None:
    ...
    op.add_column('mensagens', sa.Column('tipo', sa.String(length=20), nullable=False))
    op.add_column('mensagens', sa.Column('status', sa.String(length=20), nullable=False))
    op.add_column('mensagens', sa.Column('data_entrega', sa.DateTime(), nullable=True))
    op.add_column('mensagens', sa.Column('editada', sa.Boolean(), nullable=False))
    op.add_column('mensagens', sa.Column('data_edicao', sa.DateTime(), nullable=True))
    op.add_column('mensagens', sa.Column('deletada', sa.Boolean(), nullable=False))
