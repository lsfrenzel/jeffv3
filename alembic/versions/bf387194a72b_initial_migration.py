...
def upgrade() -> None:
    ...
    sa.Column('tipo', sa.Enum('admin', 'consultor', name='tipousuario', create_type=True), nullable=False),
    ...
    sa.Column('status', sa.Enum('planejado', 'em_andamento', 'concluido', 'cancelado', 'pausado', name='statusprojeto', create_type=True), nullable=True),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('tipo', sa.Enum('PROSPECCAO_CRIADA', 'AGENDAMENTO_CRIADO', 'AGENDAMENTO_REALIZADO', 'EMPRESA_ATRIBUIDA', 'PROSPECCAO_ATUALIZADA', name='tiponotificacao', create_type=True), nullable=False),
    ...
    sa.Column('status', sa.Enum('pendente', 'realizado', 'vencido', name='statusagendamento', create_type=True), nullable=True),
    sa.Column('observacoes', sa.Text(), nullable=True),
    sa.Column('data_criacao', sa.DateTime(), nullable=True),
    ...
    sa.Column('status', sa.Enum('pendente', 'em_andamento', 'concluida', 'cancelada', name='statusatividade', create_type=True), nullable=True),
